...
(async () => {
  ...
  const splashWindow = (0,_helpers__WEBPACK_IMPORTED_MODULE_3__.createWindow)('splash', {
    width: 340,
    height: 500,
    show: false,
    frame: false,
  ...
  if (isProd) {
    ...
    splashWindow.loadFile(path__WEBPACK_IMPORTED_MODULE_0___default().join(__dirname, '../renderer/public/splash.html'));
  }
  ...
  electron__WEBPACK_IMPORTED_MODULE_1__.ipcMain.on('minimize-window', () => {
    mainWindow.minimize();
  });
  electron__WEBPACK_IMPORTED_MODULE_1__.ipcMain.on('close-window', () => {
    mainWindow.close();
  });
